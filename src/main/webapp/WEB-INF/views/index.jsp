            ...
            <div class="row">
                ...
                <div class="col-md-6 text-center">
                    <ul class="pagination center-block" style="display:inline-block;">
                        <c:set var="totalPage" value="${(questions.questionCount + 4) / 5}"/>
                        <c:set var="currentPage" value="${questions.currentPage + 1}"/>
                        <c:set var="pageGroup" value="${(currentPage + 4) / 5}"/>
                        <c:set var="startPage" value="${(pageGroup - 1) * 5 + 1}"/>
                        <c:set var="endPage" value="${Math.min(pageGroup * 5, totalPage)}"/>
